...
const CheckoutPage = () => {
  const cartItems = [
    {
      ...
      quantity: 1,
      image:
        "https://kenhtinhoc.vn/wp-content/uploads/2022/10/mo-hinh-one-piece-monkey-d-luffy-1.jpg",
    },
    {
      id: 2,
      name: "Luffy Gear 2",
  ...
  const exchangeRate = 24500; // 1 USD = 24,500 VNĐ
  ...
  const totalPayment = totalItemsPrice + shippingFee; // USD
  const totalPaymentVND = totalPayment * exchangeRate; // VNĐ
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 bg-white mt-10">
      ...
      <div className=" p-4  flex flex-col gap-4 ">
        {cartItems.map((item) => (
          <div key={item.id} className="flex items-start p-2 gap-4 border rounded-md shadow-md">
            <img
              src={item.image}
              alt={item.name}
