...
const BoxSearch = () => {
  ...
  return (
    <div className="relative Box-Search min-w-[80px] flex-1 center bg-gray-100 hover:bg-white hover:border hover:border-red-500 h-[56px] rounded-full border border-transparent">
      <input
        ref={inputRef}
        type="text"
        placeholder="Search?"
      ...
      <div className="flex items-center h-full gap-3 pr-2">
        ...
        <Icon
          className="w-10 h-10 text-white bg-red-600 rounded-full center hover:bg-red-500"
